...
final class ExitActiveCommandMiddlewareTest extends KernelTestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->middleware = $kernel->getContainer()->get('linemob.middleware.exit_active_cmd');
    }
